...
public class SShapeTest {
    ...
    public void testXMLGeneration() {
        ...
        Assertions.assertEquals("<SShape Param1=\"0.000000\" Param2=\"5.000000\"/>", set.toXMLString(""));
    }
    ...
    public void testBetweenABLowerHalf() {
        ...
        Assertions.assertEquals(0.125, set.eval(5 / 4.), 1.e-5);
    }
    ...
    public void testBetweenABUpperHalf() {
        ...
        Assertions.assertEquals(0.875, set.eval(15 / 4.), 1.e-5);
    }
}
