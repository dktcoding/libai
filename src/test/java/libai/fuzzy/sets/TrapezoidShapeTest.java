...
public class TrapezoidShapeTest {
    ...
    public void testXMLGeneration() {
        ...
        Assertions.assertEquals("<TrapezoidShape Param1=\"0.000000\" Param2=\"5.000000\" Param3=\"10.000000\" Param4=\"15.000000\"/>", set.toXMLString(""));
    }
    ...
    public void testBeforeA() {
        TrapezoidShape set = new TrapezoidShape(0, 5, 10, 15);
        Assertions.assertEquals(0, set.eval(-1), 1.e-3);
    }

    @Test
    public void testAfterD() {
        TrapezoidShape set = new TrapezoidShape(0, 5, 10, 15);
        Assertions.assertEquals(0, set.eval(15), 1.e-3);
    }

    @Test
    public void testBetweenBC() {
        TrapezoidShape set = new TrapezoidShape(0, 5, 10, 15);
        Assertions.assertEquals(1, set.eval(7), 1.e-3);
    }

    @Test
    public void testBeforeAB() {
        TrapezoidShape set = new TrapezoidShape(0, 5, 10, 15);
        Assertions.assertEquals(0.5, set.eval(2.5), 1.e-3);
    }

    @Test
    public void testBeforeCD() {
        TrapezoidShape set = new TrapezoidShape(0, 5, 10, 15);
        Assertions.assertEquals(0.5, set.eval(12.5), 1.e-3);
    }
    ...
    public void testRightRightTrapezoid() {
        ...
        Assertions.assertEquals(1, set.eval(10), 1.e-3);
    }
