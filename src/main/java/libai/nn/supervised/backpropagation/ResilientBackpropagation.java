...
public class ResilientBackpropagation extends StandardBackpropagation {
    protected final double nPlus;
    protected final double nMinus;
    protected final double minUpdate;
    protected final double maxUpdate;
    protected final double initialUpdate;
